...
class Product(models.Model):
    ...
    subcategory = models.ForeignKey(
        Subcategory, on_delete=models.CASCADE, null=True, related_name='subcategory_products')
    ...
    price = models.DecimalField(
        verbose_name='Цена', decimal_places=2, max_digits=9)
    old_price = models.DecimalField(
        verbose_name='Старая цена', decimal_places=2, max_digits=9, default=0)

    orders_number = models.PositiveIntegerField(
        verbose_name='Кол-во покупок', default=0)
    favorites_number = models.PositiveIntegerField(
        verbose_name='Кол-во избранных', default=0)
    changes_number = models.PositiveIntegerField(
